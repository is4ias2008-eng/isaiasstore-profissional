                                                                                                          ...
                                                                                                          app.post("/api/register", (req, res) => {
                                                                                                            const { name, username, password, confirmPassword } = req.body;
                                                                                                              ...
                                                                                                              if (!name || !username || !password || !confirmPassword) {
                                                                                                                  return res.status(400).json({ error: "Preencha nome, usuário, senha e confirmação" });
                                                                                                                    }
                                                                                                                                                                                                ...
                                                                                                                                                                                                return res.status(401).json({ error: "Login inválido" });
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    const token = jwt.sign({ username: user.username, name: user.name, role: "cliente" }, JWT_SECRET, { expiresIn: "7d" });
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      app.get("/api/products", (req, res) => {
                                                                                                                                                                                                        res.json({ products: products.filter(p => p.active !== false), storeOpen });
                                                                                                                                                                                                        });

                                                                                                                                                                                                        app.get("/api/public-offers", (req, res) => {
                                                                                                                                                                                                          res.json({ products: products.filter(p => p.active !== false && p.offer === true), storeOpen });
                                                                                                                                                                                                          });
