                                                                                                                                                                      ...
                                                                                                                                                                      const token = jwt.sign({ username: user.username, role: "cliente" }, JWT_SECRET, { expiresIn: "7d" });
                                                                                                                                                                        ...
                                                                                                                                                                        app.get("/api/products", (req, res) => {
                                                                                                                                                                          const visible = products.filter(p => p.active !== false);
                                                                                                                                                                            res.json({ products: visible, storeOpen });
                                                                                                                                                                            });

                                                                                                                                                                            app.get("/api/public-offers", (req, res) => {
                                                                                                                                                                              const offers = products.filter(p => p.active !== false && p.offer === true);
                                                                                                                                                                                res.json({ products: offers, storeOpen });
                                                                                                                                                                                });
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        app.post("/api/products", auth, adminOnly, (req, res) => {
                                                                                                                                                                                                          const { name, price, image, link, category, offer } = req.body;
                                                                                                                                                                                                            if (!name || !price || !image || !link) {
                                                                                                                                                                                                                return res.status(400).json({ error: "Preencha nome, preço, imagem e link" });
                                                                                                                                                                                                                  }
